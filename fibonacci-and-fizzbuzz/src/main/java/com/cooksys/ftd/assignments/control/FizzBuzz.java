...
public class FizzBuzz {
    ...
    public static boolean divides(int a, int b) throws IllegalArgumentException {
        if (b == 0) {
        	throw new IllegalArgumentException("The provided b cannot by 0. Cannot divide by 0.");
        }
        return a % b == 0;
    }
    ...
    public static String[] messages(int start, int end) throws IllegalArgumentException {
    	if (end < start) {
    		throw new IllegalArgumentException("The provided end value must be greater than the provided start value.");
    	}
    	
//    	// Figure out how many messages are in the provided range
//    	int resultSize = 0;
...
//    	}
//    	
//    	// create our result array of messages and populate it
//        String[] result = new String[resultSize];
//        int currIdx = 0;
//        for (int i = start; i < end; i++) {
//        	if (message(i) != null) {
//        		result[currIdx] = message(i);
//        		currIdx++;
//        	}
//        }
