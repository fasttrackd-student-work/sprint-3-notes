...
public class Fibonacci {
    ...
    public static int atIndex(int i) throws IllegalArgumentException {
    	if (i < 0) {
    		throw new IllegalArgumentException("the provided value of i must be positive");
    	}
    ...
    public static int[] slice(int start, int end) throws IllegalArgumentException {
    	if (start < 0 || end < 0) {
    		throw new IllegalArgumentException("The provided start and end must be positive");
    	}
    	if (start > end) {
    		throw new IllegalArgumentException("The provided end must be greater than the provided start");
    	}
    ...
    public static int[] fibonacci(int count) throws IllegalArgumentException {
    	if (count < 0) {
    		throw new IllegalArgumentException("The provided count must be a positive value");
    	}
